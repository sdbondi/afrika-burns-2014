...
class QProjectM : public QObject, public projectM {
	...
	public:
		QProjectM(const std::string & config_file, PrismaticInputAdapter* prismatic_input = 0):
      projectM(config_file, projectM::FLAG_DISABLE_PLAYLIST_LOAD, prismatic_input) {}
